...
open class HybridTTSSpec_cxx {
   ...
   */
  @inline(__always)
  public func equals(other: HybridTTSSpec_cxx) -> Bool {
  ...
  public final var numSpeakers: Double {
    @inline(__always)
    get {
      return self.__implementation.numSpeakers
    }
  }

  // Methods
  @inline(__always)
  public final func initialize(config: TTSConfig) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
  ...
  @inline(__always)
  public final func speak(text: std.string, onAudioChunk: bridge.Func_void_std__shared_ptr_ArrayBuffer__double, onComplete: bridge.Func_void) -> bridge.Result_std__shared_ptr_Promise_void___ {
    do {
      let __result = try self.__implementation.speak(text: String(text), onAudioChunk: { () -> (ArrayBuffer, Double) -> Void in
        let __wrappedFunction = bridge.wrap_Func_void_std__shared_ptr_ArrayBuffer__double(onAudioChunk)
        return { (__samples: ArrayBuffer, __sampleRate: Double) -> Void in
          __wrappedFunction.call(__samples, __sampleRate)
        }
      }(), onComplete: { () -> () -> Void in
