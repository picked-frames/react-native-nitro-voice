...
/**
 * Wraps a Swift `(_ audio: ArrayBuffer) -> Void` as a class.
...
public final class Func_void_std__shared_ptr_ArrayBuffer_ {
  ...
  private let closure: (_ audio: ArrayBuffer) -> Void

  public init(_ closure: @escaping (_ audio: ArrayBuffer) -> Void) {
    self.closure = closure
  }

  @inline(__always)
  public func call(audio: ArrayBuffer) -> Void {
    self.closure(audio)
  }
