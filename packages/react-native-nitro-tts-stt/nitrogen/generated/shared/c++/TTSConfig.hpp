...
namespace margelo::nitro {
  ...
  template <>
  struct JSIConverter<margelo::nitro::nitrottsstt::TTSConfig> final {
    static inline margelo::nitro::nitrottsstt::TTSConfig fromJSI(jsi::Runtime& runtime, const jsi::Value& arg) {
      jsi::Object obj = arg.asObject(runtime);
      return margelo::nitro::nitrottsstt::TTSConfig(
        JSIConverter<std::string>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "modelDir"))),
        JSIConverter<margelo::nitro::nitrottsstt::TTSModelType>::fromJSI(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "type"))),
    ...
    static inline jsi::Value toJSI(jsi::Runtime& runtime, const margelo::nitro::nitrottsstt::TTSConfig& arg) {
      jsi::Object obj(runtime);
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "modelDir"), JSIConverter<std::string>::toJSI(runtime, arg.modelDir));
      obj.setProperty(runtime, PropNameIDCache::get(runtime, "type"), JSIConverter<margelo::nitro::nitrottsstt::TTSModelType>::toJSI(runtime, arg.type));
    ...
    static inline bool canConvert(jsi::Runtime& runtime, const jsi::Value& value) {
      ...
      if (!JSIConverter<margelo::nitro::nitrottsstt::TTSModelType>::canConvert(runtime, obj.getProperty(runtime, PropNameIDCache::get(runtime, "type")))) return false;
