...
/**
 * Represents the JavaScript callback `(audio: array-buffer) => void`.
...
fun interface Func_void_std__shared_ptr_ArrayBuffer_: (ArrayBuffer) -> Unit {
  ...
  @DoNotStrip
  @Keep
  override fun invoke(audio: ArrayBuffer): Unit
}
...
class Func_void_std__shared_ptr_ArrayBuffer__cxx: Func_void_std__shared_ptr_ArrayBuffer_ {
  ...
  @FastNative
  private external fun invoke_cxx(audio: ArrayBuffer): Unit
}
