...
namespace margelo::nitro::nitrottsstt {
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrottsstt/Func_void_std__string;";
  ...
  public:
    static auto constexpr kJavaDescriptor = "Lcom/margelo/nitro/nitrottsstt/Func_void_std__string_cxx;";
